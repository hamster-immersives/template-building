        ...
        <section className="hoc container clear"> 
          ...
          <ul className="nospace group services">
            <li className="one_quarter first">
              <article><a href="#"><i className="fa fa-3x fa-500px" /></a>
